...
<form method="post">
    ...
    <textarea rows="10" cols="50" name="descriptions"><?php echo $obj->description;?></textarea><br><br>
...
if ($_POST['ok']){
    ...
    $sql = "UPDATE categories SET categoryCode = '$category_code', categoryName = '$category_name', description = '$description'
